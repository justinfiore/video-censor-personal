...
- [ ] 1.1 Create `video_censor_personal/detectors/clip_detector.py` with CLIPDetector class
...
- [ ] 1.2b Add model download functionality
...
- [ ] 1.3 Implement prompt parsing and validation
...
- [ ] 2.0 Add `--download-models` flag to CLI
...
- [ ] 2.0b Implement model download in pipeline
...
- [ ] 2.1 Register CLIP detector in detector registry
...
- [ ] 2.2 Test detection framework compatibility
...
- [ ] 3.1 Unit tests for CLIPDetector (`tests/test_clip_detector.py`)
...
- [ ] 3.2 Integration tests for pipeline compatibility
...
- [ ] 4.1 Add CLIP detector section to QUICK_START.md
...
- [ ] 5.2 Validate strict OpenSpec compliance
