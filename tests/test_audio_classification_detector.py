...
class TestAudioClassificationDetectorInitialization:
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_init_with_default_config(self, mock_extractor, mock_model):
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_init_with_custom_config(self, mock_extractor, mock_model):
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_init_loads_category_mapping(self, mock_extractor, mock_model):
...
class TestCategoryMapping:
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_default_violence_mappings(self, mock_extractor, mock_model):
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_default_sexual_theme_mappings(self, mock_extractor, mock_model):
...
class TestAudioClassification:
    ...
    def test_detect_returns_empty_when_no_audio(
        self, mock_extractor, mock_model, mock_torch
    ):
    ...
    def test_detect_maps_audio_label_to_category(
        ...
        # Setup logits and softmax
        mock_outputs = MagicMock()
        mock_logits = MagicMock()
        mock_logits.argmax.return_value.item.return_value = 0
        mock_logits.softmax.return_value.max.return_value.item.return_value = 0.85
...
class TestCleanup:
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_cleanup_releases_model(self, mock_extractor, mock_model):
    ...
    @patch("video_censor_personal.audio_classification_detector.AutoModelForAudioClassification")
    @patch("video_censor_personal.audio_classification_detector.AutoFeatureExtractor")
    def test_cleanup_handles_missing_attributes(self, mock_extractor, mock_model):
