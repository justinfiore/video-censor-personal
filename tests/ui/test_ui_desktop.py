...
def mock_ctk():
    ...
    with patch("customtkinter.CTk") as mock_ctk_class, \
         patch("customtkinter.CTkFrame") as mock_frame_class:
        ...
        mock_ctk_class.return_value = mock_root
        
        # Cleanup imported modules before test
        ...
        yield mock_ctk_class, mock_root
...
def test_desktop_app_initialization(mock_ctk):
    ...
    mock_ctk_class, mock_root = mock_ctk
